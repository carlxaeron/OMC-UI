CREATE TABLE tbl_quiz (id INTEGER PRIMARY KEY, title VARCHAR(767) UNIQUE, description VARCHAR(767), category_id INTEGER, FOREIGN KEY(category_id) REFERENCES categories(id));
...
CREATE TABLE tbl_quiz_question (id INTEGER PRIMARY KEY, question VARCHAR(767), rationale VARCHAR(767), quiz_id INTEGER, FOREIGN KEY(quiz_id) REFERENCES quiz(id));
...
CREATE TABLE tbl_question_answer (id INTEGER PRIMARY KEY, answer VARCHAR(767), question_id INTEGER, is_correct INTEGER, FOREIGN KEY(question_id) REFERENCES questions(id));
