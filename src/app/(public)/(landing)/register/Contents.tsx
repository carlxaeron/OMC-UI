    ...
    <>
      <div className="px-4 pt-4">
        ...
        >
          ...
          <Step onClick={() => (storeState.userCredential && storeState.userData) && !success && storeAction.setRegisterStep(1)}>2</Step>
          <Step onClick={() => (storeState.userCredential && storeState.userData && storeState.userData?.country) && !success && storeAction.setRegisterStep(2)}>3</Step>
        </Stepper>
      </div>
      <div className="py-5">
