...
db.serialize(() => {
  ...
  db.run("CREATE TABLE IF NOT EXISTS articles (id INTEGER PRIMARY KEY, title TEXT UNIQUE, description TEXT, category_id INTEGER, FOREIGN KEY(category_id) REFERENCES categories(id))");
